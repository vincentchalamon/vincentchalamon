...
- [zenstruck/foundry](https://github.com/zenstruck/foundry) ([v2.0.2](https://github.com/zenstruck/foundry/releases/tag/v2.0.2), 4 days ago) - A model factory library for creating expressive, auto-completable, on-demand dev/test fixtures with Symfony and Doctrine.
...
- [api-platform/api-platform](https://github.com/api-platform/api-platform) ([v3.3.6](https://github.com/api-platform/api-platform/releases/tag/v3.3.6), 4 days ago) - Create REST and GraphQL APIs, scaffold Jamstack webapps, stream changes in real-time.
...
- [infection/infection](https://github.com/infection/infection) ([0.29.5](https://github.com/infection/infection/releases/tag/0.29.5), 6 days ago) - PHP Mutation Testing library
