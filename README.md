...
- [api-platform/core](https://github.com/api-platform/core) ([v3.4.0-alpha.1](https://github.com/api-platform/core/releases/tag/v3.4.0-alpha.1), today) - The server component of API Platform: hypermedia and GraphQL APIs in minutes
...
- [api-platform/demo](https://github.com/api-platform/demo) ([v3.3.11](https://github.com/api-platform/demo/releases/tag/v3.3.11), 3 weeks ago) - Demo app for the API Platform framework
- [zenstruck/foundry](https://github.com/zenstruck/foundry) ([v2.0.7](https://github.com/zenstruck/foundry/releases/tag/v2.0.7), 4 weeks ago) - A model factory library for creating expressive, auto-completable, on-demand dev/test fixtures with Symfony and Doctrine.
