...
- [api-platform/schema-generator](https://github.com/api-platform/schema-generator) ([v5.2.1](https://github.com/api-platform/schema-generator/releases/tag/v5.2.1), today) - PHP Model Scaffolding from Schema.org and other RDF vocabularies
