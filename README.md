...
- [zenstruck/foundry](https://github.com/zenstruck/foundry) ([v1.38.5](https://github.com/zenstruck/foundry/releases/tag/v1.38.5), 1 day ago) - A model factory library for creating expressive, auto-completable, on-demand dev/test fixtures with Symfony and Doctrine.
- [api-platform/demo](https://github.com/api-platform/demo) ([v4.1.4](https://github.com/api-platform/demo/releases/tag/v4.1.4), 3 days ago) - Demo app for the API Platform framework
...
- [infection/infection](https://github.com/infection/infection) ([0.29.14](https://github.com/infection/infection/releases/tag/0.29.14), 4 weeks ago) - PHP Mutation Testing library
