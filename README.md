...
- [api-platform/core](https://github.com/api-platform/core) ([v3.1.13](https://github.com/api-platform/core/releases/tag/v3.1.13), 5 days ago) - The server component of API Platform: hypermedia and GraphQL APIs in minutes
