...
- [api-platform/demo](https://github.com/api-platform/demo) ([v4.1.16](https://github.com/api-platform/demo/releases/tag/v4.1.16), 1 day ago) - Demo app for the API Platform framework
- [api-platform/core](https://github.com/api-platform/core) ([v4.1.16](https://github.com/api-platform/core/releases/tag/v4.1.16), 1 day ago) - The server component of API Platform: hypermedia and GraphQL APIs in minutes
...
- [api-platform/admin](https://github.com/api-platform/admin) ([v4.0.7](https://github.com/api-platform/admin/releases/tag/v4.0.7), 4 weeks ago) - A beautiful and fully-featured administration interface builder for hypermedia APIs
