...
- [api-platform/demo](https://github.com/api-platform/demo) ([v4.1.12.2](https://github.com/api-platform/demo/releases/tag/v4.1.12.2), 1 day ago) - Demo app for the API Platform framework
- [zenstruck/foundry](https://github.com/zenstruck/foundry) ([v2.5.4](https://github.com/zenstruck/foundry/releases/tag/v2.5.4), 3 days ago) - A model factory library for creating expressive, auto-completable, on-demand dev/test fixtures with Symfony and Doctrine.
