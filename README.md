...
- [api-platform/demo](https://github.com/api-platform/demo) ([v4.2.8](https://github.com/api-platform/demo/releases/tag/v4.2.8), today) - Demo app for the API Platform framework
