...
- [api-platform/schema-generator](https://github.com/api-platform/schema-generator) ([v5.2.1](https://github.com/api-platform/schema-generator/releases/tag/v5.2.1), 2 days ago) - PHP Model Scaffolding from Schema.org and other RDF vocabularies
- [symfony/security-bundle](https://github.com/symfony/security-bundle) ([v6.3.1](https://github.com/symfony/security-bundle/releases/tag/v6.3.1), 5 days ago) - Provides a tight integration of the Security component into the Symfony full-stack framework
- [symfony/symfony](https://github.com/symfony/symfony) ([v6.3.1](https://github.com/symfony/symfony/releases/tag/v6.3.1), 5 days ago) - The Symfony PHP framework
