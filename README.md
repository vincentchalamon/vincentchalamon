...
- [zenstruck/foundry](https://github.com/zenstruck/foundry) ([v2.5.2](https://github.com/zenstruck/foundry/releases/tag/v2.5.2), 1 day ago) - A model factory library for creating expressive, auto-completable, on-demand dev/test fixtures with Symfony and Doctrine.
...
- [api-platform/demo](https://github.com/api-platform/demo) ([v4.1.12](https://github.com/api-platform/demo/releases/tag/v4.1.12), 3 days ago) - Demo app for the API Platform framework
- [api-platform/core](https://github.com/api-platform/core) ([v4.1.12](https://github.com/api-platform/core/releases/tag/v4.1.12), 5 days ago) - The server component of API Platform: hypermedia and GraphQL APIs in minutes
