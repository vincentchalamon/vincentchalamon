...
- [zenstruck/foundry](https://github.com/zenstruck/foundry) ([v2.3.4](https://github.com/zenstruck/foundry/releases/tag/v2.3.4), 2 days ago) - A model factory library for creating expressive, auto-completable, on-demand dev/test fixtures with Symfony and Doctrine.
- [api-platform/demo](https://github.com/api-platform/demo) ([v4.0.17](https://github.com/api-platform/demo/releases/tag/v4.0.17), 4 days ago) - Demo app for the API Platform framework
- [infection/infection](https://github.com/infection/infection) ([0.29.11](https://github.com/infection/infection/releases/tag/0.29.11), 5 days ago) - PHP Mutation Testing library
