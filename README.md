...
- [api-platform/admin](https://github.com/api-platform/admin) ([v3.4.7](https://github.com/api-platform/admin/releases/tag/v3.4.7), 1 month ago) - A beautiful and fully-featured administration interface builder for hypermedia APIs
