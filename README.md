...
- [api-platform/laravel](https://github.com/api-platform/laravel) - [READ ONLY] API Platform for Laravel (5 months ago)
...
- [coopTilleuls/CoopTilleulsForgotPasswordBundle](https://github.com/coopTilleuls/CoopTilleulsForgotPasswordBundle) - Provides a &#34;forgot password&#34; complete feature for your API through a Symfony bundle (8 months ago)
...
- [api-platform/demo](https://github.com/api-platform/demo) ([v4.2.5](https://github.com/api-platform/demo/releases/tag/v4.2.5), 1 week ago) - Demo app for the API Platform framework
- [api-platform/core](https://github.com/api-platform/core) ([v4.2.5](https://github.com/api-platform/core/releases/tag/v4.2.5), 1 week ago) - The server component of API Platform: hypermedia and GraphQL APIs in minutes
- [vincentchalamon/scavenger-hunt](https://github.com/vincentchalamon/scavenger-hunt) ([v1.0.0-beta.1](https://github.com/vincentchalamon/scavenger-hunt/releases/tag/v1.0.0-beta.1), 2 weeks ago) - Jeu de piste mobile / Scavenger hunt mobile game
