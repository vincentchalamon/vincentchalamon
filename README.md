...
- [lexik/LexikJWTAuthenticationBundle](https://github.com/lexik/LexikJWTAuthenticationBundle) ([v2.19.1](https://github.com/lexik/LexikJWTAuthenticationBundle/releases/tag/v2.19.1), 1 day ago) - JWT authentication for your Symfony API
- [api-platform/schema-generator](https://github.com/api-platform/schema-generator) ([v5.2.1](https://github.com/api-platform/schema-generator/releases/tag/v5.2.1), 6 days ago) - PHP Model Scaffolding from Schema.org and other RDF vocabularies
