...
- [zenstruck/foundry](https://github.com/zenstruck/foundry) ([v2.0.5](https://github.com/zenstruck/foundry/releases/tag/v2.0.5), today) - A model factory library for creating expressive, auto-completable, on-demand dev/test fixtures with Symfony and Doctrine.
...
- [api-platform/demo](https://github.com/api-platform/demo) ([v3.3.7](https://github.com/api-platform/demo/releases/tag/v3.3.7), 5 days ago) - Demo app for the API Platform framework
