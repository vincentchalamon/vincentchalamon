...
- [zenstruck/foundry](https://github.com/zenstruck/foundry) ([v2.3.0](https://github.com/zenstruck/foundry/releases/tag/v2.3.0), today) - A model factory library for creating expressive, auto-completable, on-demand dev/test fixtures with Symfony and Doctrine.
- [infection/infection](https://github.com/infection/infection) ([0.29.9](https://github.com/infection/infection/releases/tag/0.29.9), 3 days ago) - PHP Mutation Testing library
